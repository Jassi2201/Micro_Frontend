...
<div className="p-4 rounded-xl border border-opacity-20 border-white shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(0,0,0,0.5)] backdrop-blur-sm bg-white/10">
  <div className="flex items-center justify-between">
    <div>
      <p className="font-head text-white">Total Assessments</p>
      <h3 className="text-xl sm:text-2xl font-bold mt-1 text-white">{progress.overallStats.total_assignments}</h3>
    </div>
    <div className="p-2 rounded-lg bg-gradient-to-br from-blue-900 to-blue-700 bg-opacity-30">
      <FiBook className="w-5 h-5 text-blue-300" />
           ...
           <div className="p-4 rounded-xl border border-opacity-20 border-white shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(0,0,0,0.5)] backdrop-blur-sm bg-white/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-head text-white">Questions Attempted</p>
                  <h3 className="text-xl sm:text-2xl font-bold mt-1 text-white">{progress.overallStats.total_questions_attempted}</h3>
                </div>
            ...
            <div className="p-4 rounded-xl border border-opacity-20 border-white shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(0,0,0,0.5)] backdrop-blur-sm bg-white/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-head text-white">Correct Answers</p>
                  <h3 className="text-xl sm:text-2xl font-bold mt-1 text-white">{progress.overallStats.correct_answers}</h3>
                </div>
              ...
              <p className="text-xs mt-2">
                <span className="font-head text-white">Accuracy: </span>
                <span className="font-medium text-white">{progress.overallStats.accuracy}%</span>
              </p>
            </div>
          ...
          <div className="p-4 rounded-xl border border-opacity-20 border-white shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(0,0,0,0.5)] backdrop-blur-sm bg-white/10">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-head text-white">Mastery Level</p>
                  <h3 className="text-xl sm:text-2xl font-bold mt-1 text-white">{progress.overallStats.mastery}%</h3>
                </div>
              ...
              <p className="text-xs mt-2">
                <span className="text-white">Mastered Questions: </span>
                <span className="font-medium text-white">{progress.overallStats.mastered_questions}</span>
              </p>
            </div>
          </div>

          {/* Categories Progress */}
         <div className="p-6 mb-8 rounded-xl border border-opacity-20 border-white shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(0,0,0,0.5)] backdrop-blur-sm bg-white/10">
            <h2 className="text-lg sm:text-xl font-head text-white mb-4">Category-wise Progress</h2>
              ...
              {progress.categories.map((category) => (
                <div key={category.categoryId} className="   pl-4 py-3 rounded-r-lg border border-opacity-20 border-white shadow-[0_2px_4px_rgba(255,255,255,0.05)]">
                  <div className="flex font-head justify-between items-center mb-2">
                    <h3 className="font-head text-white">{category.categoryName}</h3>
                  ...
                  <div className="flex justify-between font-head mb-1 text-sm">
                    <span className="text-white font-head">Completion</span>
                    <span className="font-head text-white">{category.completionPercentage}%</span>
                  </div>
...
<div className="p-6 rounded-xl border border-opacity-20 border-white shadow-[0_4px_6px_-1px_rgba(255,255,255,0.1),0_2px_4px_-1px_rgba(0,0,0,0.5)] backdrop-blur-sm bg-white/10">
  <h2 className="text-lg sm:text-xl font-head text-white mb-4">Recent Activity</h2>
    ...
    <table className="w-full table-fixed divide-y divide-gray-600">
      ...
      <thead>
        <tr className="border border-opacity-20 border-white">
          <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase tracking-wider truncate">Question</th>
          <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase tracking-wider truncate">Category</th>
          <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase tracking-wider truncate">Your Answer</th>
          <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase tracking-wider truncate">Correct Answer</th>
          <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase tracking-wider truncate">Status</th>
          <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase tracking-wider truncate">Time</th>
        </tr>
      </thead>
      <tbody className="divide-y divide-gray-600">
        {progress.recentActivity.map((activity) => (
          <tr key={activity.responseId}>
            <td className="px-3 py-4 text-sm font-medium text-white truncate" title={activity.question}>
              {activity.question}
            </td>
            <td className="px-3 py-4 text-sm text-white truncate" title={activity.category}>
              {activity.category}
            </td>
            <td className="px-3 py-4 text-sm text-white truncate" title={activity.userAnswer}>
              {activity.userAnswer}
            </td>
            <td className="px-3 py-4 text-sm text-white truncate" title={activity.correctAnswer}>
            ...
            <td className="px-3 py-4 text-sm text-white truncate" title={new Date(activity.responseTime).toLocaleString()}>
