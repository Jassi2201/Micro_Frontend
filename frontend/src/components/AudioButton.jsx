...
useEffect(() => {
  ...
  return (
    <button
      onClick={handlePlay}
      className="ml-2 p-2 rounded-full text-white/80 hover:text-white flex items-center justify-center border border-white/20 hover:border-white/40 transition-all duration-300"
